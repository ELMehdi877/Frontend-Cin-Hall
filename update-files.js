...
const moviesListContent = `import { useEffect, useState } from "react";
...
fs.writeFileSync(path.join(__dirname, 'src', 'components', 'MoviesList.jsx'), moviesListContent);
console.log('App.jsx and MoviesList.jsx updated successfully');
